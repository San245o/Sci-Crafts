-- Run this in the Supabase SQL Editor for an existing marketplace project.
-- It adds buyer/seller roles, private seller verification details, and seller-only product inserts.
