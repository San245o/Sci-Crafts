...
export function Description() {
  ...
  useGSAP(
    () => {
      ...
      // Independent continuous hovering animations
      gsap.to(".badge-1", {
        y: "-=10",
        rotationZ: "-=3",
        rotationX: "+=15",
  ...
  return (
    <section
      ref={containerRef}
      className="relative z-10 flex min-h-screen flex-col items-center justify-center bg-[#ef4444] px-6 sm:px-10 md:px-16 lg:px-20"
    >
